<html>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="{{route('DiaDanh.dsDiaDanh')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('NhuCau.dsNhuCau')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Nhu cầu</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="{{route('QuanAn.dsQuanAn')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="nav-link-text ms-1">Quán ăn</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="{{route('NoiLuuTru.dsNoiLuuTru')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Nơi lưu trú</span>
          </a>
        </li>
        <li class="nav-item">
          ...
          <a class="nav-link  " href="">
            ...
            <span class="nav-link-text ms-1">Duyệt địa danh</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/sign-in.html">
            ...
            <span class="nav-link-text ms-1">Đăng kí</span>
          </a>
        </li>
        <li class="nav-item">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder mb-0">@yield('TT')</h6>
        </nav>
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                  ...
                  @else
                    <img src="/storage/{{Auth::user()->HinhAnh}}" class="avatar avatar-sm  me-3 ">
                    <span class="d-sm-inline d-none">{{Auth::user()->Hoten_Nguoidung}}</span>
                  @endif
            ...
            <li class="nav-item d-xl-none ps-3 d-flex align-items-center">
             ...
             <li class="nav-item dropdown  px-3 d-flex align-items-center">
              ...
              <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="{{route('dangxuat')}}">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="/assets/img/icon/logout.png" class="avatar avatar-sm bg-gradient-dark  me-3 ">
                      </div>
