    ...
    <div class="row">
        <div class="col-4">
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="TenDiaDanh" placeholder="Tên địa danh">
             </div>
        </div>
    <div class="col-4">
        <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Tên gọi khác</label>
                <input type="email" class="form-control" id="TenGoiKhac" placeholder="Tên gọi khác">
        </div>
    </div>
   <div class="mb-3">
...
<div class="row">
    <div class="col-6">
        ...
        <div class="mb-3">
            <img src="../assets/img/team-3.jpg" height="100" width="100"> 
        </div>
    </div>
     <div class="col-6">
        <div class="mb-3">
